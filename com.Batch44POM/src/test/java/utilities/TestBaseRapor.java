...
public static ExtentHtmlReporter extentHtmlReporter; // Html raporu duzenler
...
public void setUpTest() {
	...
	extentReports.setSystemInfo("Automation Engineer", "Mehmet Fatih");
	extentHtmlReporter.config().setDocumentTitle("TestNG Report");
